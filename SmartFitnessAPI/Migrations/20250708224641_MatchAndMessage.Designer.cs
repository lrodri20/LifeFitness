...
namespace SmartFitness.Migrations
{
    ...
    [Migration("20250708224641_MatchAndMessage")]
    partial class MatchAndMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.MatchRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.ProfileSchedule", b =>
                {
                    ...
                    b.ToTable("ProfileSchedules", "auth");
                });
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.Match", b =>
                {
                    b.HasOne("SmartFitnessApi.Models.Profile", "User1")
                        .WithMany("MatchesAsUser1")
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SmartFitnessApi.Models.Profile", "User2")
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.Message", b =>
                {
                    b.HasOne("SmartFitnessApi.Models.Match", "Match")
                        .WithMany("Messages")
                        .HasForeignKey("MatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SmartFitnessApi.Models.Profile", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartFitnessApi.Models.ProfileActivity", b =>
                {
                    ...
                    b.HasOne("SmartFitnessApi.Models.Profile", null)
                        .WithMany("Activities")
